function removeOrderInDB( forElement, mesa, amount )
{
	//Type of food 1 or 2 ( menu or pizza )
	type = forElement.substring( forElement.length - 1 )
	
	idFood = forElement.replace( mesa, '' ).replace( type, '' );
